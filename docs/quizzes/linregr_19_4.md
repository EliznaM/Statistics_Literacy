...
QUIZ FOR CORRELATION AND LIN REGR, 19.4 
...
A. The difference between the observed y and the predicted y   
...
B. Underestimates that observation   
...
B. For every 1-unit increase in x, y increases by about 4.2 units  
...
A. 62% of the variability in y is explained by x   
...
B. After controlling for other variables, x2 is associated with a decrease in y   
