...
D)  The hypothesis that a difference exists between groups  
...
distribution, but on the t-distribution.  
...
B)  The observed effect is unlikely to be due to random chance alone  
...
noticeable effects in the real world   
...
A)  The effect size is small despite a low p-value   
...
A)  Reject the null hypothesis; there is evidence for a difference   
...
loads for each of Day 4, 7, 14 and 28, at 4 degrees Celsius.  
b) The researchers used t-tests to compare Day 0 CMV viral loads to CMV viral 
loads for each of Day 4, 7, 14, 28 and 90, at -20 degrees Celsius.  
c) The researchers tested a total of 11 hypotheses pertaining to the differences 
in CMV viral load at different time points and temperatures. 
...
B. There is no difference in viral load between day 0 and day 28.  
...
C. There is a difference in viral load between day 0 and day 90.  
...
C. Viral loads remained stable over time at both 4 °C and −20 °C.   
...
at 4 °C and -20 °C.  
B. There is no difference in viral load over 90 days for samples stored at 4 °C.  
C. There is no difference in viral load over 28 days for samples stored at -20 °C.  
D. Storage time is not associated with viral load for samples stored at 4 °C.  
